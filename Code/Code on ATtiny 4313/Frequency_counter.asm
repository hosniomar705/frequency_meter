...
;nastav  bity 0,1,2,3 jako vystup
;nastav  bity 4,5,6 jako vstup
LDI REG,0b00001111
OUT SMER2,REG
LDI REG,0b11010000
OUT PORT2,REG
...
TECKA1NE:
OUT PORT,REG
LDI REG,0b11011000  ;da log1 na bit0 portu. 
OUT PORT2,REG
RET
...
TECKA2NE:
OUT PORT,REG
LDI REG,0b11010100  ;da log1 na bit1 portu.
OUT PORT2,REG
RET
...
TECKA3NE:
OUT PORT,REG
LDI REG,0b11010010  ;da log1 na bit2 portu.
OUT PORT2,REG
RET
...
TECKA4NE:
OUT PORT,REG
LDI REG,0b11010001  ;da log1 na bit3 portu.
OUT PORT2,REG
RET
...
CPC UDAJ3,REG
BRLO MENSI_7
SUBI UDAJ1,64		;24-bitove odcit n  cisla 1 000 000 od vysledku
SBCI UDAJ2,66
SBCI UDAJ3,15
INC CIF7
RJMP ZNOVU_7
...
CPC UDAJ3,REG
BRLO MENSI_6
SUBI UDAJ1,160		;24-bitove odcit n  cisla 100 000 od vysledku
SBCI UDAJ2,134
SBCI UDAJ3,1
INC CIF6
RJMP ZNOVU_6
...
CPC UDAJ3,REG
BRLO MENSI_5
SUBI UDAJ1,16		;24-bitove odcit n  cisla 10 000 od vysledku
SBCI UDAJ2,39
SBCI UDAJ3,0
INC CIF5
RJMP ZNOVU_5
...
CPC UDAJ2,REG
BRLO MENSI_4
SUBI UDAJ1,232		;16-bitove odcit n  cisla 1 000 od vysledku
SBCI UDAJ2,3
INC CIF4
RJMP ZNOVU_4
MENSI_4:
...
CPC UDAJ2,REG
BRLO MENSI_3
SUBI UDAJ1,100		;16-bitove odcit n  cisla 100 od vysledku
SBCI UDAJ2,0
INC CIF3
RJMP ZNOVU_3
MENSI_3:
...
BRLO MENSI_2
SUBI UDAJ1,10		;8-bitove odcit n  cisla 10 od vysledku
INC CIF2
RJMP ZNOVU_2
MENSI_2:
